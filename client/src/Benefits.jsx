export default function Benefits({ selected, onChange }) {
  ...
  return (
    <>
      <label className='flex items-center border cursor-pointer rounded-2xl gap-2 p-4'>
      ...
      <label className='flex items-center border cursor-pointer rounded-2xl gap-2 p-4'>
        <input type='checkbox' checked={selected.includes('fp')} name='fp' onChange={handleCheck} />
        <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' strokeWidth={1.5} stroke='currentColor' className='w-6 h-6'>
      ...
      <label className='flex items-center border cursor-pointer rounded-2xl gap-2 p-4'>
        <input type='checkbox' checked={selected.includes('pe')} name='pe' onChange={handleCheck} />
        <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 24' strokeWidth={1.5} stroke='currentColor' className='w-6 h-6'>
